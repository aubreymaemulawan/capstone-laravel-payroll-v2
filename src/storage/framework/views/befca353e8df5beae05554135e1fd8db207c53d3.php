...
<section class="third-party-lists shadow text-center">
    <div class="container container-sm-xl text-white px-lg-5">
        ...
        <ul class="list-unstyled my-5 tp-list-ul">
            <li class="shadow-sm">
                <img src="<?php echo e(asset('images/landing-page/gmail.png')); ?>" alt="">
            </li>
            <li class="shadow-sm">
                <img src="<?php echo e(asset('images/landing-page/webmail.png')); ?>" alt="">
            </li>
            <li class="shadow-sm">
                <img src="<?php echo e(asset('images/landing-page/mailgun.png')); ?>" alt="">
            </li>
            <li class="shadow-sm">
                <img src="<?php echo e(asset('images/landing-page/aws.png')); ?>" alt="">
            </li>
...
<?php /**PATH C:\laragon\www\payroll\src\resources\views/welcome.blade.php ENDPATH**/ ?>