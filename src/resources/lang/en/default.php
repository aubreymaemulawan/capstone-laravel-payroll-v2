...
return array_merge([
    ...
    'csv_required_field_guide_attendance' => "Required field's (employee id, time in/out) column cell must not be empty.",
    'csv_column_data_format_attendance' => 'The column : employee_id value must be the same value that exists on the application and the time in/out column must be a date format of \'Y-m-d H:m:s\' (the hour should be 24hour format)',
